...
namespace QuizesApi.Migrations
{
    ...
    [Migration("20251108191229_ForceCreateQuestionBankColumns")]
    partial class ForceCreateQuestionBankColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizesApi.Models.QuestionBank", b =>
                {
                    ...
                    b.Property<string>("BankDescription")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("BankDescription");

                    b.Property<string>("BankKey")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("BankKey");
                    ...
                    b.Property<string>("OptionE")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("OptionE");

                    b.Property<string>("OptionF")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("OptionF");

                    b.Property<string>("OptionG")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("OptionG");

                    b.Property<string>("OptionH")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("OptionH");
            ...
            modelBuilder.Entity("QuizesApi.Models.StudentExamAnswer", b =>
                {
                    ...
                    b.HasIndex(new[] { "QuestionId" }, "IX_StudentExamAnswer_QuestionId");
            ...
            modelBuilder.Entity("QuizesApi.Models.Subject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex(new[] { "SubjectName" }, "UQ_Subject_SubjectName")
                        .IsUnique();
            ...
            modelBuilder.Entity("ExamDetail", b =>
                {
                    ...
                    b.HasOne("QuizesApi.Models.Subject", "Subject")
                        .WithMany("ExamDetails")
